...
import { 
    // Image, 
    Text, Icon, StarRating, Tag } from "@components";
import { BaseColor } from "@config";
import PropTypes from "prop-types";
import styles from "./styles";
export default class ClinicPackageItem extends Component {
    constructor(props) {
        super(props);
    }
    /**
        ...
        return (
            <View style={style}>
                <TouchableOpacity onPress={onPress} activeOpacity={0.9}>
                    <Image style={styles.blockImage} source={{ uri: `${this.props.image}` }} />
                </TouchableOpacity>
    ...
    renderGrid() {
        ...
        return (
            <View style={[styles.girdContent]}>
                <TouchableOpacity onPress={onPress} activeOpacity={0.9}>
                    <Image source={{uri: `${this.props.image}`}} style={styles.girdImage} />
                </TouchableOpacity>
...
ClinicPackageItem.defaultProps = {
    style: {},
    image: "",
    city: "",
    country: "",
