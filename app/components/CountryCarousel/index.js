...
import SliderEntry2 from './components/SliderEntry2';
...
export default class CountryCarouselComponent extends Component {
    ...
    mainExample2 (textName, title, subtitle) {
        const { slider1ActiveSlide } = this.state;
        ...
        return (
            <View style={styles.exampleContainer}>
                ...
                <Carousel
                  ...
                  // inactiveSlideShift={20}
                  containerCustomStyle={styles.slider}
                  contentContainerCustomStyle={[styles.sliderContentContainer], {marginLeft: -47}}
                  loop={false}
                  loopClonesPerSide={2}
                  autoplay={false}
                  autoplayDelay={500}
    ...
    carouselRenderrer(carouselType, textName){
        const example1 = this.mainExample(textName, "Browse beautiful places to stay with all the comforts of home, plus more.");
        const example2 = this.mainExample2(textName, "Browse beautiful places to stay with all the comforts of home, plus more.");
