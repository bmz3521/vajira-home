export default Images = {
   ...
   * Common
   */
  ic_avatar: require('./imgs/avatar.png'),
  ic_back: require('./imgs/back.png'),
  ic_default: require('./imgs/ic_default.png'),
  ic_wechat: require('./imgs/ic_wechat.png'),
  ic_twitter: require('./imgs/ic_twitter.png'),
  ic_tiktok: require('./imgs/ic_tiktok.png'),
  ic_meituan: require('./imgs/ic_meituan.png'),
  ...
  ic_meituan_scan: require('./imgs/ic_scan_meituan.png'),
  ic_meituan_ar: require('./imgs/ic_ar.png'),
  ic_qrcode: require('./imgs/ic_qrcode.png'),
  ic_flashlight: require('./imgs/ic_flashlight.png'),
  ic_gallery: require('./imgs/ic_gallery.png'),
  ic_tiktok_scan_bar: require('./imgs/ic_douyin_scan_line.png'),
};
