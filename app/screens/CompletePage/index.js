...
export default class CompletePage extends Component {
    constructor(props) {
        super();
        this.state = {
    ...
    render() {
      ...
      >
          ...
          {/* <ProfileDescription
             ...
             <View style={{marginBottom: 30, marginTop: 30, paddingHorizontal: 20}}>
                 ...
                 โรงพยาบาที่ขอสิทธิ
                  ...
                  <Text bold style={{marginTop: 20, fontSize: 24 }}>
                  เสร็จเรียบร้อยท่านได้มอบข้อมูลให้กับ 
                  </Text>
                  <Text bold style={{marginTop: 20, fontSize: 24 }}>
                  โรงพยาบาลสมิติเวช 
                  </Text>
                  ...
                  <Text headline semibold style={{fontSize: 16}}>
                  สิทธิโรคที่คุณจะมอบได้ให้กับผู้รับ
                  </Text>
                  <View style={{flexDirection:'row'}} >
                  <Text bold style={{ marginTop: 20, fontSize: 30 }}>
              ...
              style={{height: 120, width: 120,marginTop: 5, borderRadius: 100, marginLeft: 250, fontSize: 14,}}>เสร็จสิ้น</Button>
          </ScrollView>
      </SafeAreaView>
        );
    }
...
const s = StyleSheet.create({
  ...
  AppRegistry.registerComponent('default', () => CompletePage);
