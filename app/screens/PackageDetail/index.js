...
// Load sample data
import { UserData, ReviewData, PackageData, ClinicPackageData } from "@data";
...
export default class PackageDetail extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            clinicPackageItem2: PackageData[2]
        };
    }
...
class InformationTab extends Component {
    ...
    render() {
        let { information, dayPackage, packages } = this.state;
        return (
            <ScrollView>
 ...
 * @extends {Component}
 */
class ClinicPackageTab extends Component {
    constructor(props) {
        super(props);
        this.state = {
            clinicPackageItem: PackageData[0],
    ...
    render() {
        const { clinicPackageItem, clinicPackageItem2 } = this.state;
            ...
            <ScrollView>
                <View style={{ paddingHorizontal: 20 }}>
                    <Text body2 style={{ marginTop: 20 }}>
                        ...
                        states. Our Europe multi-country packages are some of the
                    ...
                    <PackageItem
                        ...
                        services={clinicPackageItem.services}
                        onPressIcon={() => {
                    ...
                    <PackageItem
                        detail
                        packageName={clinicPackageItem2.packageName}
                        price={clinicPackageItem2.price}
                        type={clinicPackageItem2.type}
                        description={clinicPackageItem2.description}
                        services={clinicPackageItem2.services}
                    />
                </View>
            </ScrollView>
        );
